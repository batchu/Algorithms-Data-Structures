...
public class LinkedPositionalList<E> implements PositionalList<E> {
  //---------------- nested net.batchu.exercises.Node class ----------------
  /**
   * net.batchu.exercises.Node of a doubly linked list, which stores a reference to its
  ...
  private static class Node<E> implements Position<E> {
    ...
    /**
     * Sets the node's previous reference to point to net.batchu.exercises.Node n.
    ...
    /**
     * Sets the node's next reference to point to net.batchu.exercises.Node n.
     * @param n    the node that should follow this one
     */
    public void setNext(Node<E> n) {
      next = n;
    }
  } //----------- end of nested net.batchu.exercises.Node class -----------
   ...
   * @return    the underlying net.batchu.exercises.Node instance at that position
