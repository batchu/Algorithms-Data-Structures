...
public class TreeMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  protected static class BalanceableBinaryTree<K,V>
    ...
    // this extends the inherited LinkedBinaryTree.net.batchu.exercises.Node class
    ...
    // Override node factory function to produce a BSTNode (rather than a net.batchu.exercises.Node)
    @Override
    protected
